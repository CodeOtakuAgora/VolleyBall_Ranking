...
--
-- Hôte : localhost:3306
-- Généré le : ven. 15 mai 2020 à 11:43
...
INSERT INTO `volley_admin` (`id`, `login`, `password`)
VALUES (1, 'admin', '$2y$12$Omx9WMNQwXaoD6P/mCnlt.eh98Vabsq8cBa3UumtViavJfIFvl9Cq');
...
INSERT INTO `volley_equipes` (`id`, `nom`)
VALUES (1, 'Carrières Sur Seine'),
       (2, 'Chatou'),
       (3, 'Deux-Rives'),
       (4, 'Les Essarts'),
       (5, 'Feucherolles'),
...
INSERT INTO `volley_matchs` (`id`, `id_equipe1`, `id_equipe2`, `resultat`, `sets`, `scores`, `points`, `penalites`)
VALUES (1, 1, 2, 'Victoire', '2 / 0', '25 / 23  25 / 19', '51 / 42', 'Match interrompu par coupure d\'électricité'),
       ...
       (6, 2, 5, 'Défaite', '0 / 3', '14 / 25  22 / 25  14 / 25', '50 / 75',
        'Licence référent Feucherolles non visée - Indulgence'),
       (7, 2, 3, 'Défaite', '0 / 3', '21 / 25  23 / 25  9 / 25', '53 / 75',
        'Retard envoi feuille de match / licences non visées - Indulgence'),
       (8, 2, 9, 'Défaite', '0 / 3', '12 / 25  16 / 25  15 / 25', '43 / 75',
        'Retard envoi feuille de match - Indulgence'),
       (9, 3, 10, 'Défaite', '0 / 3', '16 / 25  10 / 25  15 / 25', '41 / 75',
        'Licences 2 Rives non visées - Indulgence'),
       (10, 3, 2, 'Victoire', '3 / 0', '25 / 21  25 / 23  25 / 9', '75 / 53',
        'Retard envoi feuille de match / licences non visées - Indulgence'),
       (11, 3, 6, 'Défaite', '0 / 3', '21 / 25  15 / 25  17 / 25', '53 / 75', 'RAS'),
       (12, 4, 6, 'Défaite', '1 / 3', '27 / 25  16 / 25  15 / 25  18 / 25', '76 / 100',
        'Manque nom équipe Fontenay - Indulgence'),
       ...
       (16, 5, 7, 'Défaite', '1 / 3', '25 / 22  24 / 26  22 / 25  20 / 25', '91 / 98',
        'Feucherolles 1 licence sans photo - Indulgence'),
       (17, 5, 2, 'Victoire', '3 / 0', '25 / 14  25 / 22  25 / 14', '75 / 50',
        'Licence référent Feucherolles non visée - Indulgence'),
       (18, 5, 11, 'Victoire', '3 / 0', '25 / 8  25 / 8  25 / 22', '75 / 38',
        'Retard envoi feuille de match - Indulgence '),
       (19, 5, 1, 'Victoire', '3 / 1', '25 / 17  25 / 22  22 / 25  25 / 16', '97 / 80', 'RAS'),
       (20, 6, 4, 'Victoire', '3 / 1', '25 / 27  25 / 16  25 / 15  25 / 18  ', '100 / 76',
        'Manque nom équipe Fontenay - Indulgence'),
       ...
       (24, 7, 5, 'Victoire', '3 / 1', '22 / 25  26 / 24  25 / 22  25 / 20', '98 / 91',
        'Feucherolles 1 licence sans photo - Indulgence'),
       ...
       (35, 9, 2, 'Victoire', '3 / 0', '25 / 12  25 / 16  25 / 15', '75 / 43',
        'Retard envoi feuille de match - Indulgence'),
       (36, 10, 3, 'Victoire', '3 / 0', '25 / 16  25 / 10  25 / 15', '75 / 41',
        'Licences 2 Rives non visées - Indulgence'),
       ...
       (41, 11, 5, 'Défaite', '0 / 3', '8 / 25  8 / 25  22 / 25', '38 / 75',
        'Retard envoi feuille de match - Indulgence'),
       ...
       (49, 1, 3, 'Victoire', '3 / 1', '21 / 25  25 / 16  26 / 24  25 / 20', '97 / 85',
        'Manque date, terrains et points totaux'),
       ...
       (53, 3, 1, 'Défaite', '1 / 3', '25 / 21  16 / 25  24 / 26  20 / 25', '85 / 97',
        'Manque date, terrains, et points totaux'),
...
INSERT INTO `volley_resultats` (`id`, `victoires`, `defaites`, `nb_sets_gagnes`, `nb_points_total`, `id_equipe`)
VALUES (1, 4, 1, 12, 379, 1),
       (2, 0, 5, 0, 235, 2),
       (3, 2, 3, 7, 329, 3),
       (4, 1, 4, 4, 335, 4),
       (5, 3, 2, 11, 417, 5),
